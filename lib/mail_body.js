        ...
        <div
            style="
                ...
                <img src="https://cdn.sforum.vn/sforum/wp-content/uploads/2018/11/2-10.png"
                    ...
                    <a href="https://arial-movie.herokuapp.com/api/v1/auth/verify?email=${email}&crb=${sv}" style="background-color: rgb(0,128,255); border: none; color: white; border-radius : 5px;
                        padding: 15px 32px;
                        text-align: center;
